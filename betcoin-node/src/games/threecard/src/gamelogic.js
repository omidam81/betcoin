 ...
 * @returns {number}
 */
GameLogic.prototype.getPairplusPay = function(playerHandRank, pairplus) {
 ...
 * @returns {number}
 */
GameLogic.prototype.getAnteBonus = function(playerHandRank, ante) {
 ...
 */
GameLogic.prototype.getPayouts = function(playerHandRank, ante, pairplus, action, dealerQualified, isWin, isPush) {
...
GameLogic.prototype.getHouseEdge = function(ante, pairplus){
    var houseEdges = {
        ante: 0.0337,
        pairplus: 0.0232
    };
 ...
 */
GameLogic.prototype.getResult = function(dealerHand, playerHand, ante, pairplus, action){
