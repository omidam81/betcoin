...
module.exports = function(logger, io, HTTPError, provable, BaseGameController, BaseGameModel, getExchangeRate, Config) {
    ...
    var GameController = require('./src/controller')(GameModel, logger, io, HTTPError, BaseGameController, getExchangeRate, Config);
