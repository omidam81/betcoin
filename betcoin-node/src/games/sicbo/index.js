...
module.exports = function(BaseGameModel, logger, io, HTTPError, provable, BaseGameController) {
    ...
    var GameController = require('./src/controller')(GameModel, gameLogic, logger, io, HTTPError, BaseGameController);
