...
module.exports = function(BaseGameModel, GameLogic, logger, HTTPError, provable) {
    ...
    var Game = BaseGameModel('baccarat')
        .attr('final_array')
    ...
    Game.prototype.play = function(params, cb) {
        ...
        // logger.baccarat("playing seed: ",client_seed);
        ...
        // logger.baccarat('##### playing game %s for %s (%s) #####', self.primary(), player.username(), player_id);
        // logger.baccarat('result');

        // logger.baccarat('wager %d winnings %d player profit %d',
        //                 wager.toBitcoin(),
        //                 winnings.toBitcoin(),
        ...
        logger.baccarat('##### done playing game %s for %s (%s) ##### %s', self.primary(), player.username(), player_id, client_seed);
        // save the game data
