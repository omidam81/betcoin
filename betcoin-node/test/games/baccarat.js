            ...
            it('should play a game', function(done) {
                request.post('/' + GAME)
                    ...
                    .send({
                        ...
                        bets: "{\"banker\":1000, \"player\":2000, \"tie\": 3000}"
                    })
                    .expect(200)
                    .expect(function(res) {
                    ...
                    .end(function(err, res) {
                        ...
                        Wallet.get(wallet.primary(), function(err, _wallet) {
                            if (err) return done(err);
                            var newBalance = INITIAL_BALANCE - 6000 + res.body.winnings;
            ...
            it('should reject a NaN wager', function(done) {
                request.post('/' + GAME)
                    ...
                    .send({
                        gameId: nextGameId,
                        client_seed: getUsername(),
                        bets: "{\"banker\":1000, \"player\":2000, \"tie\": \"a\"}"
                    })
                    .expect(400)
                    .expect(function(res) {
                ...
                async.times(5, function(i, next) {
                    ...
                    request.get('/' + GAME + '/leaderboard')
                        ...
                        .expect(function(res) {
                            ...
                            assert.equal(res.body[0].wagered, 30000);
                        })
                        .end(done);
