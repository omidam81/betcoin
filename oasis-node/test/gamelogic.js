...
describe('oasis game logic', function () {
    ...
    describe('isDealerQualifiedCards', function() {
        it('should qualify dealer cards', function (done) {
            ...
            var dealerHand = gameLogic.getCardResult(['s14','s12','s11','s10','h9']);
            var dealerQualified = gameLogic.isDealerQualifiedCards(dealerHand);
    ...
    describe('getResult', function() {
        it('should forfeit cards, ante bet for fold', function (done) {
            ...
            var wager = 9000;
            var holds = [true, true, true, true, true];
            var result = gameLogic.getResult(dealerHand, playerHand, wager, false, 0);
            console.log('*************Player Cards***************');
            console.log(result.playerHand.initCards[0].rank);
            console.log(result.playerHand.initCards[1].rank);
            console.log(result.playerHand.initCards[2].rank);
            console.log(result.playerHand.initCards[3].rank);
            console.log(result.playerHand.initCards[4].rank);
            console.log('*************Dealer Cards***************');
            console.log(result.dealerHand.initCards[0].rank);
            console.log(result.dealerHand.initCards[1].rank);
            console.log(result.dealerHand.initCards[2].rank);
            console.log(result.dealerHand.initCards[3].rank);
            console.log(result.dealerHand.initCards[4].rank);
        ...
        it('should pay 4 * ante if player raises and dealer card is not qualified', function (done) {
           var hands = gameLogic.initHands('test');
            ...
            var wager = 9000;
            var holds = [true, true, true, true, true];
            var result = gameLogic.getResult(dealerHand, playerHand, wager, true, 0);
        ...
        it('should pay 4 * ante - 1 * ante(fee) + (2 * ante) * payout_multiplier if player raises with 1 switchs, dealer cards are qualified and beaten by player cards', function (done) {
           var hands = gameLogic.initHands('test');
            var finalArray = hands.allCards;
            var playerHand = {
                initCards: [
            ...
            var wager = 9000;
            var holds = [false, true, true, true, true];
            var result = gameLogic.getResult(dealerHand, playerHand, wager, true, 1);
            assert.equal(3000 * 4 - 1 * 3000 + (2 * 3000) * payout_multipliers[result.playerHand.rnk], result.payout);
            assert.equal(true, result.isWin);
            assert.equal(false, result.isPush);
            assert.equal(false, result.isFold);
            assert.equal(true, result.dealerHand.qualified);
        ...
        describe('getPlayerFinalCards', function() {
            it('should replace canceled cards', function (done) {
                ...
                console.log('*************Player Cards***************');
                console.log(playerHand.initCards[0].rank);
                console.log(playerHand.initCards[1].rank);
                console.log(playerHand.initCards[2].rank);
                console.log(playerHand.initCards[3].rank);
                console.log(playerHand.initCards[4].rank);
                console.log('*************Final Array***************');
                console.log(finalArray[5].rank);
                console.log(finalArray[6].rank);
                console.log(finalArray[7].rank);
                console.log(finalArray[8].rank);
                console.log(finalArray[9].rank);
                ...
                console.log(finalCards[0].rank);
                console.log(finalCards[1].rank);
                console.log(finalCards[2].rank);
                console.log(finalCards[3].rank);
                console.log(finalCards[4].rank);
