...
container.register('appName', 'tigerdragon');
...
// resitered later
container.register('namespace', 'tigerdragon');
container.register('io', require('socket-npm'));
// now get the models
// the models have DI compatable function signatures
container.register('Tigerdragon', require('../models/game'));
// and the controllers
// the controllers also have DI compatable function signatures
container.register('TigerdragonController', require('../controllers/game'));
