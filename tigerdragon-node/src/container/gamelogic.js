...
module.exports = function() {
    ...
    this.getCardRankOrder = function(card) {
        var cards = ["A", "2", "3", "4", "5", "6", "7", "8", "9", "T", "J", "Q", "K"];
    ...
    this.dealCard = function(playerHand, bankerHand, remainingCards){
        return {
            playerHand: playerHand,
            bankerHand: bankerHand,
    ...
    this.getPayout = function(hands, bets){
        var payouts = {
            total: 0,
            player: 0,
            banker: 0,
        ...
        } else if (hands.bankerHand.rankOrder < sevenRankOrder && bets.bankerbig) {
        ...
        payouts.total = payouts.player + payouts.banker + payouts.tie + payouts.suitedtie + payouts.playerbig + payouts.playersmall + payouts.playerc + payouts.palyerd + payouts.playerh + payouts.players + payouts.bankerbig + payouts.bankersmall + payouts.bankerc + payouts.bankerd + payouts.bankerh + payouts.bankers;
    ...
    this.getResult = function(hands, bets){
