...
var RouletteApi = function(container) {
    this.container = container;
};

RouletteApi.prototype.init = function(port) {
    ...
    // initialize routing
    this.container.register('routes', require('./routes/index'));
...
RouletteApi.prototype.getServer = function() {
...
if (require.main === module) {
    ...
    var api = new RouletteApi(container);
    api.init(argv.port);
}
