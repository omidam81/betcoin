...
container.register('appName', 'roulette');
...
// resitered later
container.register('namespace', 'roulette');
container.register('io', require('socket-npm'));
// now get the models
// the models have DI compatable function signatures
container.register('Roulette', require('../models/roulette'));
// and the controllers
// the controllers also have DI compatable function signatures
container.register('RouletteController', require('../controllers/roulette'));
