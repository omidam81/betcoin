...
describe('caribbean game logic', function () {
    ...
    describe('getResult', function() {
        it('should forfeit cards, ante bet for fold', function (done) {
            ...
            var wager = 9000;
            var result = gameLogic.getResult(dealerHand, playerHand, wager, false);
        ...
        it('should pay 4 * ante if player raises and dealer card is not qualified', function (done) {
            ...
            var wager = 9000;
            var result = gameLogic.getResult(dealerHand, playerHand, wager, true);
