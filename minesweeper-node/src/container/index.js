...
container.register('appName', 'minesweeper');
...
// resitered later
container.register('namespace', 'minesweeper');
container.register('io', require('socket-npm'));
// now get the models
// the models have DI compatable function signatures
container.register('Minesweeper', require('../models/minesweeper'));
// and the controllers
// the controllers also have DI compatable function signatures
container.register('MinesweeperController', require('../controllers/minesweeper'));
