...
module.exports = function() {
    ...
    this.rolldice = function(clientseed, serverseed) {
    ...
    this.validateBet = function(betType) {
        if (!self.table.thepoint){
    ...
    this.validateBetOptions = function(current, previous){
    ...
    this.returnBets = function(returnBets, previous){
        var options = this.analyzeOptions(previous);
        var total = 0;
    ...
    this.analyzeOptions = function(table){
        var options = {
            field: true,
            pass: true,
            dontpass: true,
    ...
    this.getMaxMultiplier = function(thepoint) {
