...
var TileApi = function(container) {
    this.container = container;
};

TileApi.prototype.init = function(port) {
...
TileApi.prototype.getServer = function() {
...
if (require.main === module) {
    ...
    var api = new TileApi(container);
    api.init(argv.port);
}

module.exports = TileApi;
