    ...
    var playGame = function(gameData, cb) {
        gameData.play(this, function(err, gameResult) {
            ...
            if(gameResult.status() === 'finished'){
                io.send(gameResult.player_id(), 'player bj added', gameResult);
                io.excludeRoom(gameResult.player_id(), 'bj added', gameResult);
            }
