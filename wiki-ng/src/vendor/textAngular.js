...
textAngular.directive("textAngular", ['$compile', '$window', '$document', '$rootScope', '$timeout', 'taFixChrome', function($compile, $window, $document, $rootScope, $timeout, taFixChrome) {
	...
	$rootScope.textAngularTools = deepExtend({
		...
		ul: {
			display: "<button type='button' ng-click='action()' ng-class='displayActiveToolClass(active)'><i class='glyphicon glyphicon-list'></i></button>",
			action: function() {
		...
		ol: {
			display: "<button type='button' ng-click='action()' ng-class='displayActiveToolClass(active)'><i class='glyphicon glyphicon-th-list'></i></button>",
			action: function() {
		...
		quote: {
			display: "<button type='button' ng-click='action()' ng-class='displayActiveToolClass(active)'><i class='glyphicon glyphicon-indent-left'></i></button>",
			action: function() {
		...
		undo: {
			display: "<button type='button' ng-click='action()' ng-class='displayActiveToolClass(active)'><i class='glyphicon glyphicon-share-alt'></i></button>",
			action: function() {
				return this.$parent.wrapSelection("undo", null);
			}
		},
		redo: {
			display: "<button type='button' ng-click='action()' ng-class='displayActiveToolClass(active)'><i class='glyphicon glyphicon-tasks'></i></button>",
			action: function() {
				return this.$parent.wrapSelection("redo", null);
			}
		},
		bold: {
			display: "<button type='button' ng-click='action()' ng-class='displayActiveToolClass(active)'><i class='glyphicon glyphicon-bold'></i></button>",
			action: function() {
		...
		justifyLeft: {
			display: "<button type='button' ng-click='action()' ng-class='displayActiveToolClass(active)'><i class='glyphicon glyphicon-align-left'></i></button>",
			action: function() {
		...
		justifyRight: {
			display: "<button type='button' ng-click='action()' ng-class='displayActiveToolClass(active)'><i class='glyphicon glyphicon-align-right'></i></button>",
			action: function() {
		...
		justifyCenter: {
			display: "<button type='button' ng-click='action()' ng-class='displayActiveToolClass(active)'><i class='glyphicon glyphicon-align-justify'></i></button>",
			action: function() {
		...
		italics: {
			display: "<button type='button' ng-click='action()' ng-class='displayActiveToolClass(active)'><i class='glyphicon glyphicon-italic'></i></button>",
			action: function() {
		...
		underline: {
			display: "<button type='button' ng-click='action()' ng-class='displayActiveToolClass(active)'><i class='glyphicon glyphicon-text-width'></i></button>",
			action: function() {
		...
		clear: {
			display: "<button type='button' ng-click='action()' ng-class='displayActiveToolClass(active)'><i class='glyphicon glyphicon-random'></i></button>",
			action: function() {
				return this.$parent.wrapSelection("removeFormat", null);
			}
		},
		insertImage: {
			display: "<button type='button' ng-click='action()' ng-class='displayActiveToolClass(active)'><i class='glyphicon glyphicon-paperclip'></i></button>",
			action: function() {
				var imageLink;
		...
		insertLink: {
			display: "<button type='button' ng-click='action()' ng-class='displayActiveToolClass(active)'><i class='glyphicon glyphicon-link'></i></button>",
			action: function() {
				var urlLink;
		...
		unlink: {
			display: "<button type='button' ng-click='action()' ng-class='displayActiveToolClass(active)'><i class='glyphicon glyphicon-wrench'></i></button>",
			action: function() {
