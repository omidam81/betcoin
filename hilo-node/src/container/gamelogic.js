...
module.exports = function() {
    ...
    this.makeCardSuits = function (cards, seed) {
        var suits = ['C','D','H','S'];
        var suitsToShuffle = [];
    ...
    this.getGameOdds = function(remainingCards, previousCards) {
     ...
     */
    this.guessColorCardCount = function(previousCards){
        var possibles = {
            red: 6,
            black: 6
        };
     ...
     */
    this.guessSmallerOrBiggerCount = function(previousCards){
    ...
    this.getResult = function(cards, betType, wager, previousCards){
        var newCard;
        var pickOrder;
        var nextGameOdds;
        var payoutGameOdds;
    ...
    this.getPossiblePayouts = function(gameOdds, wager) {
        var possiblePayouts = {};
    ...
    this.getPossibleMultipliers = function(gameOdds) {
        var possibleMultipliers = {};
        for(var oddType in gameOdds){
            if(gameOdds.hasOwnProperty(oddType)){
    ...
    this.getCardColor = function(suit){
    ...
    this.validPickOrder = function(pickOrder, cardCount){
