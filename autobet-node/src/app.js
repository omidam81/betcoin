...
var AutobetApi = function(container) {
    this.container = container;
};

AutobetApi.prototype.init = function(port) {
    ...
    this.container.resolve(function(routes, WorkflowExecutor, logger) {
...
AutobetApi.prototype.getServer = function() {
...
if (require.main === module) {
    ...
    var api = new AutobetApi(container);
    api.init(argv.port);
}

module.exports = AutobetApi;
