...
container.register('appName', 'coinflip');
...
// resitered later
container.register('namespace', 'coinflip');
container.register('io', require('socket-npm'));
// now get the models
// the models have DI compatable function signatures
container.register('Coinflip', require('../models/coinflip'));
// and the controllers
// the controllers also have DI compatable function signatures
container.register('CoinflipController', require('../controllers/coinflip'));
