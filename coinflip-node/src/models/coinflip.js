...
module.exports = function(modelStore, PlayerInterface, logger) {
    ...
    Game.prototype.play = function(params, cb) {
        ...
        logger.info("playing seed: ",client_seed," with bet",JSON.stringify(bet));
    ...
    var getPayouts = function(game) {
        ...
        logger.debug("multiplier %d wager %s payoutsum %s", multiplier, wager.toBitcoin(), payoutsum.toBitcoin());
        var resultData = {sum: payoutsum, houseEdge: 0.0165, gameOdds:1/possibles};
