...
var CoinflipApi = function(container) {
    this.container = container;
};

CoinflipApi.prototype.init = function(port) {
...
CoinflipApi.prototype.getServer = function() {
...
if (require.main === module) {
    ...
    var api = new CoinflipApi(container);
    api.init(argv.port);
}

module.exports = CoinflipApi;
