...
Application.Directives.directive('btcWager', ['$filter', 'BCSession', function($filter){
    return {
        require: 'ngModel',
        link: function(scope, element, attrs, ngModel) {
            var inputParser = function (inputValue) {
                ...
                var inputFloat = parseFloat(transformedInput).toSatoshi();
    ...
    return {
        ...
        link: function(scope, element, attrs) {
            ...
            scope.$watch('percentSliderValue', function(sliderValue) {
                if(Boolean(attrs.noReset) !== true){
                    if(sliderValue > parseInt(attrs.max) || !attrs.max) {
                        scope.percentSliderValue = 0;
                        sliderValue = 0;
                    }
