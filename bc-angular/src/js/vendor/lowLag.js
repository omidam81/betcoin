...
//coerce to be an array
	...
	this.playSoundWebkitAudio= function(tag){
        ...
        lowLag.gainNode = this.gainNode;
        if (!lowLag.gainNode && context.createGain) {
            lowLag.gainNode = context.createGain();
        }
        if (!lowLag.gainNode && context.createGainNode) {
            lowLag.gainNode = context.createGainNode();
        }
