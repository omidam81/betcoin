...
var provablyFair = function() {
    return {
        ...
        link: function(scope) {
            ...
            scope.rolldice = function(clientseed, serverseed) {
                var matrixSeed = sha512hmac(clientseed, serverseed);
                var res = seededMatrix(matrixSeed, {
                    height: 1,
                    width: 2,
                    min: 1,
                    max: 6
            ...
            scope.verifyFair = function(){
                var centerMatrix = scope.rolldice(scope.clientSeed, scope.serverSeed);
