...
var GameController = function($rootScope, $scope, $filter, LowLagSounds, $cookies, $location, BCPlayer, VisibilityFactory, Game) {
    ...
    $scope.$on('balance update', function(event, newbalance){
        BCPlayer.BCSession.user.wallets[newbalance.currency].balance = newbalance.balance;
    });
    ...
    $scope.nextAction = function(){
        if(gameController.getWager() === gameController.getBalance()){
            if(gameController.getWager() > 0){
