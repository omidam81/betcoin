...
var FantanApi = function(container) {
    this.container = container;
};

FantanApi.prototype.init = function(port) {
...
FantanApi.prototype.getServer = function() {
...
if (require.main === module) {
    ...
    var api = new FantanApi(container);
    api.init(argv.port);
}

module.exports = FantanApi;
